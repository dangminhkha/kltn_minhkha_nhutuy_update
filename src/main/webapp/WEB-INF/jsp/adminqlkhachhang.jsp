			...
			<div class="col-lg-6">
				...
				<table class="table table-striped">
					...
					<tr>
						...
						<td>${kh.socmnd }</td>
						<td>${kh.solandat }</td>
						<td>${kh.thoigiandangky }</td>
						<td>${kh.thoigiancapnhat }</td>
					</tr>
					</c:forEach>
				...
				<div class="submit-button text-center">						
								<a class="page-style1" href="qlkhachhang?page=${pageTruoc}">Trước </a>
								<c:if test="${page1!=null}">
								<a class="page-style1" href="qlkhachhang?page=${page1}">${page1 }</a></c:if>
								<c:if test="${page2!=null}">
								<a class="page-style1" href="qlkhachhang?page=${page2}">${page2 }</a></c:if>
								<a class="page-style" href="">${pageHienTai }</a>
								<c:if test="${page4!=null}">
								<a class="page-style1" href="qlkhachhang?page=${page4}">${page4 }</a></c:if>
								<c:if test="${page5!=null}">
								<a class="page-style1" href="qlkhachhang?page=${page5}">${page5 }</a></c:if>
								<a class="page-style1" href="qlkhachhang?page=${pageSau}">Sau </a>
							</div></c:if>
				</div>
			</div>
		</div>
