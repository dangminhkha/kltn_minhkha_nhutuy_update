...
<body>
	...
	<div class="contact-box">
		<div class="container">
			<div class="row">
				<div class="col-lg-8">
					<form action="luucapnhap" id="capnhatForm" method="post">
						<p>Họ và tên </p><input class="form-control" type="text" name="ten" id="ten" placeholder="Họ và tên" value="${dtocapnhat.ten }" /><br>
						<p class="error-ten color-red"></p>
						<p>Ngày sinh </p><input value="${dtocapnhat.ngaysinh }" class="form-control" type="date" name="ngaysinh" id="ngaysinh"  /><br>
						<p class="error-ngaysinh color-red"></p>
						<p>Nơi sinh </p><input class="form-control" type="text" name="noisinh" id="noisinh" placeholder="Quê quán" value="${dtocapnhat.noisinh }" /><br>
						<p class="error-noisinh color-red"></p>
						<p>Số điện thoại </p><input class="form-control" type="text" name="sodienthoai" id="sodienthoai" placeholder="Số điện thoại" value="${dtocapnhat.sodienthoai }"><br>
						<p class="error-sodienthoai color-red"></p>
						<p>Email </p><input class="form-control" type="text" name="email" id="email" placeholder="Email" value="${dtocapnhat.email }" /><br>
						<p class="error-email color-red"></p>
						<p>Số CMND </p><input class="form-control" type="text" name="socmnd" id="socmnd" placeholder="Số CMND" value="${dtocapnhat.socmnd }" /><br>
						<p class="error-cmnd color-red"></p>
						<div class="submit-button text-center">
							<input type="submit" class="btn btn-common" value="Lưu">
							<p class="error color-red">${trungsdtemail }</p>
						</div>
					</form>
				</div>
			</div>
