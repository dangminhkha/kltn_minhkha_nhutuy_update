		...
		<div class="container">
			...
			<div class="col-lg-12">
				...
				<table class="table">
					...
					<c:forEach var="nv" items="${nhanvientvs }"> 
						<tr> 
							<td>${nv.ten }</td>
							<td>${nv.sodienthoai }</td>
							<td>${nv.cmnd }</td>
							<td>${nv.thoigianvaoFM }</td>
						</tr>
					</c:forEach>
				</table>
				<div class="submit-button text-center">
				<a href="formthemnvthoivu?nhomid=${nhom.id }" class="btn btn-common">Thêm Nhân Viên</a>
				</div>
				</div>
			</div>
		</div>
