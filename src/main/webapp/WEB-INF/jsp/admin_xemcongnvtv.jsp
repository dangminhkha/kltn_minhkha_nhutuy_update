	...
	<div class="contact-box">
		<div class="container">
			...
			<div class="col-lg-4">
						...
						<div class="col-lg-8">
							<div class="heading-title text-center">
								<form action="xemcongnvtv" method="get">
								<input type="hidden" id="id" name="id" value="${nv.id }">
								...
								<div class="col-lg-2">
									...
									<div class="col-lg-3">
									<button type="submit" class="btn btn-success"> Xem Công</button>
									</div>
									</div>
								</form>
							</div>
			...
			<div  id="GFG" > 
				...
				<h2>Bảng công tháng ${thang } năm ${nam }</h2> </div>
				<table  class="table">
				...
				<table border="1" style="width:100%">
					...
					<c:forEach var="cong" items="${congs }"> 
						<tr> 
							<td>${cong.ngaycongFM }</td>
							<td>${cong.cong }</td>
							<td>${cong.luongFM }</td>
						</tr>
					</c:forEach>
					<tr> 
							<td colspan="2">Tổng lương tháng này</td>
