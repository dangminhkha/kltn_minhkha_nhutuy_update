					...
					<div class="row">
						<div class="col-lg-12">
							<div class="heading-title text-center">
								<h2>Thông tin loại món</h2>
							</div>
						</div>
					</div>
						<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							<form action="luuloaimon" id="loaimonForm" method="post">
								<p>Tên</p><input class="form-control" type="text" name="ten" id="ten" placeholder="Tên Loại" value="${loaimaloi.ten}" /><br>
								<p class="error-ten color-red">${tenloailoi }</p>
								<p>Loại</p>
