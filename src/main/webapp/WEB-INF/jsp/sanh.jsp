					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="heading-title text-center">
								<form action="timsanh" method="get">
						...
						<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							...
							<div class="submit-button text-center">						
								<a class="page-style1" href="sanh?page=${pageTruoc}">Trước </a>
								<c:if test="${page1!=null}">
								<a class="page-style1" href="sanh?page=${page1}">${page1 }</a></c:if>
								<c:if test="${page2!=null}">
								<a class="page-style1" href="sanh?page=${page2}">${page2 }</a></c:if>
								<a class="page-style" href="">${pageHienTai }</a>
								<c:if test="${page4!=null}">
								<a class="page-style1" href="sanh?page=${page4}">${page4 }</a></c:if>
								<c:if test="${page5!=null}">
								<a class="page-style1" href="sanh?page=${page5}">${page5 }</a></c:if>
								<a class="page-style1" href="sanh?page=${pageSau}">Sau </a>
							</div>
							</c:if>
						</div>
					</div>
