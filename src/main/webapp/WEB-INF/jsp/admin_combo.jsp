					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="heading-title text-center">
								<form action="admintimcombo" method="get">
						...
						<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							...
							<c:forEach var="cb" items="${dscombo }">
								<div class="col-lg-4 col-md-6 special-grid drinks ">
								
									<div class="gallery-single fix">
										<img src="images/khungthucdon.png" class="img-fluid whytext" alt="Image">
										<div class="center-text-img">
											<h2 align="center">${cb.ten }</h4>
											<h3 align="center">Danh sách món</h4>
											<c:forEach var="m" items="${cb.ctcombos }">
											<p>${m.stt } - ${m.mon.ten }</p>
											</c:forEach>
											<h3>Giá: ${cb.giaFM }</h3>
									...
									<div class="submit-button text-center">
										<a href="/xoacombo?id=${cb.id }" class="btn btn-success"><i class="fa fa-trash"></i> Xóa</a>
									</div>
									<br><br>
								</div>	
							</c:forEach>
							...
							<div class="submit-button text-center">						
								<a class="page-style1" href="qlcombo?page=${pageTruoc}">Trước </a>
								<c:if test="${page1!=null}">
								<a class="page-style1" href="qlcombo?page=${page1}">${page1 }</a></c:if>
								<c:if test="${page2!=null}">
								<a class="page-style1" href="qlcombo?page=${page2}">${page2 }</a></c:if>
								<a class="page-style" href="">${pageHienTai }</a>
								<c:if test="${page4!=null}">
								<a class="page-style1" href="qlcombo?page=${page4}">${page4 }</a></c:if>
								<c:if test="${page5!=null}">
								<a class="page-style1" href="qlcombo?page=${page5}">${page5 }</a></c:if>
								<a class="page-style1" href="qlcombo?page=${pageSau}">Sau </a>
							</div>
							</c:if>
						</div>
					</div>
					<div class="submit-button text-center">
								<a class="btn btn-common" href="/themcombo">Thêm Combo</a>
							</div>
				</div>
			</div>
		</div>
