		...
		<div class="container">
			...
			<div class="row inner-menu-box">
				...
				<div class="row">
					...
					<div align="center" class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							<div align="center" class="row">
							
							<table class="table">
								<tr> 
									<td>Khách Hàng </td>
									<td>${hoadon.ttDatTiec.nguoidung.ten } </td>
								</tr>
								<tr> 
									<td>Số điện thoại </td>
									<td>${hoadon.ttDatTiec.nguoidung.sodienthoai } </td>
								</tr>
								<tr> 
									<td>Email </td>
									<td>${hoadon.ttDatTiec.nguoidung.email } </td>
								</tr>
								<tr> 
									<td>Ngày tổ chức </td>
									<td>${hoadon.ttDatTiec.ngaytochuc } </td>
								</tr>
								<tr> 
									<td>Ca tổ chức </td>
									<td>${hoadon.ttDatTiec.catochuc } </td>
								</tr>
								<tr>
							...
							<table  border="1" style="width:100%">
								...
								<c:forEach var="cthd" items="${cthoadons }">
									
									<c:if test="${cthd.combo!=null}">
									
									<tr>
										<td>${cthd.combo.ten }</td>
										<td>${cthd.combo.giaFM }</td>
										<td>${cthd.soluong}</td>
										<td>${cthd.giaFM }</td>
									</tr>
									</c:if>
								...
								<c:if test="${cthd.mon!=null}">
									<tr>
										<td>${cthd.mon.ten }</td>
										<td>${cthd.mon.giaFM }</td>
										<td>${cthd.soluong}</td>
										<td>${cthd.giaFM }</td>
									</tr>
									</c:if>
								...
								<tr>
									...
									<td colspan="1">${hoadon.giaFM} </td>
								</tr>
								<tr>
									<td colspan="3" align="center">Tiền cọc</td>
									<td colspan="1">${hoadon.ttDatTiec.tiencocFM} </td>
								</tr>
								<tr>
									<td colspan="3" align="center">Tổng trả</td>
									<td colspan="1">${hoadon.tientra} </td>
								</tr>
