	...
	<div class="contact-box">
		<div class="container">
			<div class="row">
				...
				<form action="/luunhanvien" id="nhanvienForm" method="post">
						...
						<p>Xác nhận mật khẩu </p><input class="form-control" type="password" name="rematkhau" id="rematkhau" placeholder="Nhập lại mật Khẩu" value="${dto.rematkhau }" />${passfail}<br>
						
						<div class="submit-button text-center">
							<input type="submit" class="btn btn-common" value="Lưu">
							<p class="error color-red">${thongbaothemnv }</p>
						</div>
					</form>
				</div>
			</div>
