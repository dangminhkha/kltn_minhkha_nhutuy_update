		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Chào Mừng Bạn Đến Với <br> Live Dinner Restaurant</strong></h1>
							<p class="m-b-40">Live Dinner Restaurant được đánh giá cao và là sự lựa chọn 
							hàng đầu của các cặp đôi cho ngày đám cưới trọng đại, với sự tận tâm và tinh tế 
							từ những tiểu tiết nhỏ nhất bên cạnh không gian và cơ sở vật chất được đầu tư.</p>
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="/dattiec">Đặt Tiệc Ngay</a></p>
						</div>
					</div>
				</div>
			</li>
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Chào Mừng Bạn Đến Với <br> Live Dinner Restaurant</strong></h1>
							<p class="m-b-40">Live Dinner Restaurant Nơi tổ chức sinh nhật TP.HCM đẹp? Nếu bạn vẫn còn lo
							 lắng về không gian và việc lựa chọn món ăn hợp lý cho buổi tiệc sắp tới, mời bạn cùng đến
							  Live Dinner Restaurantg</p>
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="/dattiec">Đặt Tiệc Ngay</a></p>
						</div>
					</div>
				</div>
			...
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Chào Mừng Bạn Đến Với <br> Live Dinner Restaurant</strong></h1>
							<p class="m-b-40">Tổ chức hội nghị là việc làm rất cần thiết của nhiều công ty doanh nghiệp trong cuộc sống hiện đại. 
							Tổ chức hội nghị muốn thành công phải đầu tư nhiều tâm sức và thời gian.</p>
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="/dattiec">Đặt Tiệc Ngay</a></p>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						...
						<a class="btn btn-lg btn-circle btn-outline-new-white" href="gioithieu">Xem Chi Tiết</a>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					<p class="lead ">
						  ...
						  Đặt tiệc ngay tại Live Dinner Restaurant nào để cùng thưởng thức những giây phút đặt biệt nào!!!
					</p>
					<span class="lead">Live Dinner Restaurant</span>
				</div>
			</div>
		</div>
	</div>
