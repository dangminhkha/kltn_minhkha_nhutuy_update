...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Thêm nhân viên phục vụ</title>  
...
<li class="nav-item dropdown active">
	...
	<div class="contact-box">
		<div class="container">
			<div class="row">
			<div class="col-lg-12">
				<form action="lunhanvienthoivu" method="post" id="formnvtv">
					<table class="table">
						<tr>
							<td>Tên</td>
							<td>
								<input class="form-control" type="text" name="ten" id="ten"  />
								<p class="error-ten color-red">${thongbaonvtv }</p>
							</td>
						</tr>
						<tr>
							<td>Chứng Minh Nhân Dân</td>
							<td>
							<input class="form-control" type="text" name="cmnd" id="cmnd"  />
