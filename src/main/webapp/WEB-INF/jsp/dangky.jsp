...
<body>
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<c:if test="${userDangNhap==null}">
							<li class="nav-item active"><a class="nav-link" href="formdangky">ĐĂNG KÝ</a></li>
	...
	<div class="contact-box">
		<div class="container">
			<div class="row">
				<div class="col-lg-10">
					<form id="dangkyform" action="dangky" method="post">
						...
						<p>Mật khẩu </p><input class="form-control" type="password" name="matkhau" id="matkhau" placeholder="Mật Khẩu" value="${dto.matkhau }" /><br>
						<p class="error-mk color-red"></p>
						<p>Xác nhận mật khẩu </p><input class="form-control" type="password" name="rematkhau" id="rematkhau" placeholder="Nhập lại mật Khẩu" value="${dto.rematkhau }" /><p class="color-red">${passfail}</p><br>
						
						<div class="submit-button text-center">
							<input type="submit" class="btn btn-common" value="Đăng Ký">
							<p class="error color-red"></p><p class="color-red">${sdtemail }</p>
						</div>
					</form>
				</div>
			</div>
