			...
			<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbars-rs-food" aria-controls="navbars-rs-food" aria-expanded="false" aria-label="Toggle navigation">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						%>
						<li class="nav-item active"><a class="nav-link" href="/thongke">Thống Kê</a></li>
	...
	<div class="contact-box">
		<div class="container">
			...
			<div class="col-lg-4">
						...
						<h3>Bảng thống kê của tháng ${thang } năm ${nam }</h3> </div>
			<table  border="1" style="width:100%">
				<tr> 
					<td>Tổng đơn đặt tiệc </td>
					<td>${thongke.tongdondattiec } </td>
				</tr>
				<tr> 
					<td>Tổng đơn đã tổ chức </td>
					<td>${thongke.tongdondathanhtoan } </td>
				</tr>
				<tr> 
					<td>Tổng đơn đã hủy </td>
					<td>${thongke.tongdondahuy } </td>
				</tr>
				<tr> 
					<td>Doanh thu </td>
					<td>${thongke.tongtiendathanhtoanFM } </td>
				</tr>
				<tr> 
					<td>Tổng lương cho nhân viên chính thức </td>
					<td>${thongke.tongluongnhanvienchinhthucFM } </td>
				</tr>
				
				<tr> 
					<td>Tổng lương cho nhân viên thời vụ </td>
					<td>${thongke.tongluongnhanvienthoivuFM } </td>
				</tr>
			</table>
			</div>
			</div> 
			...
			<div class="submit-button text-center">
				<a href="" class="btn btn-success" onclick="printDiv()"><i class="fa fa-print" aria-hidden="true"></i> In Thống Kê </a>  
				<a href="thongke/downloadpdf" class="btn btn-warning" ><i class="fa fa-file-powerpoint-o" aria-hidden="true"></i> File PDF </a>  
			</div>
		</div>
	</div>
	<!-- End Contact -->
