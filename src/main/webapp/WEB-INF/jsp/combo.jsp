			...
			<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbars-rs-food" aria-controls="navbars-rs-food" aria-expanded="false" aria-label="Toggle navigation">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="/combo">Combo</a></li>
					...
					<div class="tab-content" id="v-pills-tabContent">
						...
						<div class="col-lg-6">
							<div class="heading-title text-center">
								<form action="timcombo" method="get">
						...
						<p>${dsrong }</p>
							...
							<div class="submit-button text-center">						
								<a class="page-style1" href="combo?page=${pageTruoc}">Trước </a>
								<c:if test="${page1!=null}">
								<a class="page-style1" href="combo?page=${page1}">${page1 }</a></c:if>
								<c:if test="${page2!=null}">
								<a class="page-style1" href="combo?page=${page2}">${page2 }</a></c:if>
								<a class="page-style" href="">${pageHienTai }</a>
								<c:if test="${page4!=null}">
								<a class="page-style1" href="combo?page=${page4}">${page4 }</a></c:if>
								<c:if test="${page5!=null}">
								<a class="page-style1" href="combo?page=${page5}">${page5 }</a></c:if>
								<a class="page-style1" href="combo?page=${pageSau}">Sau </a>
							</div></c:if>
						</div>
					</div>
