			...
			<div class="col-lg-6">
						...
						<div class="col-lg-6">
							<div class="heading-title text-center">
								<form action="xemluongcanhan" method="get">
								<div class="row no-gutters">
								<div class="col-lg-8"> </div>
								<div class="col-lg-4">
									<select class="form-control" onchange="this.form.submit()" name="nam" id="nam">
										<option>Chọn năm để xem</option>
									    <option>2020</option>
									    <option>2021</option>
									    <option>2022</option>
									    <option>2023</option>
				...
				<h2>Bảng lương năm ${namxemluong }</h2> </div>
					<form action="formcapnhat" method="get">
						<table class="table table-striped">
							<tr>
								<td><p>Tháng</p></td>
								<td><p>Tổng công của tháng</p></td>
								<td><p>Số công cá nhân trong tháng</p></td>
								<td><p>Tiền lương</p></td>
							</tr>
							<c:forEach var="luong" items="${luongcanhans }"> 
								<tr>
									<td><p>${luong.thang }</p></td>
									<td><p>${luong.ngaycongthang }</p></td>
									<td><p>${luong.songaycong }</p></td>
									<td><p>${luong.tienluongFM }</p></td>
								</tr>
							</c:forEach>
						</table>
