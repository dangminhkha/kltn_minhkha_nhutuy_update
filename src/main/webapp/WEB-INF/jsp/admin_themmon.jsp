					...
					<div class="row">
						<div class="col-lg-12">
							<div class="heading-title text-center">
								<h2>Thông Tin Món Mới</h2>
							</div>
						</div>
					</div>
						<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							<form action="/luumon" id="themmonForm" method="post" enctype="multipart/form-data">
								<p>Tên </p><input class="form-control" type="text" name="ten" id="ten" placeholder="Tên" value="${monnew.ten }" /><br>
								<p class="error-ten color-red">${monloi }</p>
								<p>Giá </p><input value="${monnew.gia }" class="form-control" type="text" name="gia" id="gia" placeholder="Giá"  /><br>
								<p class="error-gia color-red">${gialoi }</p>
								<p>Loại</p>
								  <select class="form-control" name="loai" id="loai">
								  <c:forEach var="lm" items="${loaimon }">
									 <option>${lm.ten}</option>
								</c:forEach>
								  </select>
								  <br>
								<p>Ghi chú</p><textarea class="form-control" id="ghichu" name="ghichu" ></textarea>
								<p>Hình</p>
