				...
				<div class="col-12">
					<div class="tab-content" id="v-pills-tabContent">
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="v-pills-home"
								...
								<div class="row">
									...
									<c:forEach var="cb" items="${dscombochon }">
										<div class="col-lg-4  col-md-6 special-grid drinks">
											<div class="gallery-single fix">
										<a href="/choncombo?id=${cb.id }">
										<img src="images/khungthucdon.png" class="img-fluid whytext" alt="Image"> </a>
										<div class="center-text-img">
										<a href="/choncombo?id=${cb.id }" >
											<h2 align="center">${cb.ten }</h2> 
											<h3 align="center">Danh sách món</h3>
						...
						<div class="submit-button text-center">
							<a href="/tieptucdattiec" class="btn btn-info">Quay Lại </a> <a href="/khtaocombo" class="btn btn-common">Tạo Combo</a>
						</div>
					</div>
				</div>
			</div>
