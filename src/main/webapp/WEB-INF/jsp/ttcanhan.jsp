...
<body>
	...
	<div class="contact-box">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<form action="formcapnhat" method="get">
						<table class="table table-striped">
							...
							<tr>
								...
								<td><p>${userDangNhap.thoigiandangky}</p></td>
							</tr>
							<tr>
								<td><p>Số lần đặt</p></td>
								<td><p>${userDangNhap.solandat}</p></td>
							</tr>
							<tr>
								<td><p>Thời gian cập nhật cuối cùng</p></td>
								<td><p>${userDangNhap.thoigiancapnhat}</p></td>
							</tr>
						</table>
