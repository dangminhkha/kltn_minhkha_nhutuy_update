		...
		<div class="row">
						...
						<div class="col-lg-6">
							<div class="heading-title text-center">
								<form action="admintimmon" method="get">
				...
				<div class="col-3">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<c:forEach var="lm" items="${loaimon }">
							<a class="nav-link" href="/qlmon?id=${lm.id }">${lm.ten}</a>
						</c:forEach>
					...
					<div class="tab-content" id="v-pills-tabContent">
						...
						<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							...
							<div class="col-lg-4 col-md-6 special-grid drinks">
									...
									<a href="adminchitietmon?id=${mon.id }">
							...
							<div class="submit-button text-center">						
							<a class="page-style1" href="qlmon?id=${idloai }&page=${pageTruoc}">Trước </a>
							<c:if test="${page1!=null}">
							<a class="page-style1" href="qlmon?id=${idloai }&page=${page1}">${page1 }</a></c:if>
							<c:if test="${page2!=null}">
							<a class="page-style1" href="qlmon?id=${idloai }&page=${page2}">${page2 }</a></c:if>
							<a class="page-style" href="">${pageHienTai }</a>
							<c:if test="${page4!=null}">
							<a class="page-style1" href="qlmon?id=${idloai }&page=${page4}">${page4 }</a></c:if>
							<c:if test="${page5!=null}">
							<a class="page-style1" href="qlmon?id=${idloai }&page=${page5}">${page5 }</a></c:if>
							<a class="page-style1" href="qlmon?id=${idloai }&page=${pageSau}">Sau </a>
										
						</div>
						</c:if>
				
						<div class="submit-button text-center">	
						<a class="btn btn-common" href="/themmon">Thêm Món Mới</a>
						</div>
						</div>
					</div>
				</div>
