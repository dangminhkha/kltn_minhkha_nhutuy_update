...
<body>
	...
	<div class="contact-box">
		<div class="container">
			...
			<div class="col-lg-4">
						...
						<div class="col-lg-8">
							<div class="heading-title text-center">
								<form action="bangluong" method="get">
								...
								<div class="col-lg-2">
									...
									<div class="col-lg-3">
									<button type="submit" class="btn btn-success"> Xem Bảng Lương</button>
									</div>
									</div>
								</form>
							</div>
			...
			<h3 align="center">Bảng lương tháng ${thanghientai } năm ${namhientai }</h3> </div>
			<table style="width: 100%" border="1">
				<tr> 
					<td>Tên nhân viên</td>
					<td>Tháng</td>
					<td>Năm</td>
					<td>Tổng công tháng</td>
					<td>Số công cá nhân</td>
					<td>Tiền lương</td>
				</tr>
				<c:forEach var="luong" items="${dsLuong }"> 
				<tr> 
					<td>${luong.nhanvien.ten }</td>
					<td>${luong.thang }</td>
					<td>${luong.nam }</td>
					<td>${luong.ngaycongthang }</td>
					<td>${luong.songaycong }</td>
					<td>${luong.tienluongFM }</td>
				</tr>
			
			</c:forEach>
				<tr> 
					<td colspan="5">Tổng Lương tháng này là </td>
				
					<td>${tongluongthang }</td>
				</tr>
			</table>
		...
		<div class="col-lg-12"> 
			<div class="submit-button text-center">
				<a href="" class="btn btn-success" onclick="printDiv()"><i class="fa fa-print" aria-hidden="true"></i> In Bảng Lương </a>  
			</div>
		</div>
	</div>
		</div>
