		...
		<div class="container">
			<div class="row inner-menu-box">
						...
						<div class="col-12">
							<div class="tab-pane fade show active" id="v-pills-home"
								...
								<div class="row">
									...
									<c:forEach var="loai" items="${loaimons }">
									<div class="heading-title">
										<h1>${loai.ten } </h1>
										</div>
										<div class="row">

											<c:forEach var="mon" items="${loai.mons }">
												<div class="col-lg-4 col-md-6 special-grid drinks">
										
											<div class="gallery-single fix">
											<a href="/chonmonan?id=${mon.id }">
												<img src="${mon.hinh }" class="img-fluid khuongdschon" alt="Image">
											</a>	
											</div>
											<a href="/chonmonan?id=${mon.id }">
											<h2 class="color-Maroon">${mon.ten }</h2>
											<p>${mon.giaFM }</p> 
													<br><br>
													 </a>
													 </div> 
				...
				<div class="col-4">
						...
						<div class="tab-content" id="v-pills-tabContent"> 
						<table class="table">
						<c:forEach var="ctcb" items="${combokh.ctcombos }"> 
							
							
								<tr> 
									<td> 
										<p>${ctcb.stt } - ${ctcb.mon.ten } </p>
									</td>
									<td> 
										${ctcb.mon.giaFM }
									</td>
									<td> 
										<a href="bochonmon?id=${ctcb.mon.id }&stt=${ctcb.stt }">Xóa</a>
									</td>
								</tr>	
						...
						<tr> 
							...
							<a href="/quaylaichoncombo" class="btn btn-info">Quay Lại </a> 
							<c:if test="${combokh.gia>0}"> 
							<a href="/combokhtieptuc" class="btn btn-common">Tiếp tục</a>
							</c:if>
