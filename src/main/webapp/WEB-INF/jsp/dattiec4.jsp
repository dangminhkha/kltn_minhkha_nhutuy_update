			...
			<div class="row inner-menu-box">
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="v-pills-home"
								...
								<div class="row">
									...
									<c:forEach var="mon" items="${dsNuoc }">
										<div class="col-lg-4 col-md-6 special-grid drinks">
								
									<div class="gallery-single fix">
									<a href="/chonnuoc?id=${mon.id }">
				...
				<div class="row">
						...
						<table class="table">
											...
											<c:forEach var="nuoc" items="${ttdattiec.ctNuocDatTiecs }">
												<tr>
												<td>
												${nuoc.mon.ten }</td>
												<td>${nuoc.mon.giaFM }/1 </td>
												<td> <a href="xoanuocdattiec?id=${nuoc.mon.id }&trang=chonmon">Xóa</a> </td><br>
												</tr>
											</c:forEach>
											</table>
				</div>
				<div class="col-12 submit-button text-center">
							...
							<a href="/xemthongtindt" class="btn btn-common">Tiếp Tục </a>
						</div>
