...
<li class="nav-item dropdown">
	...
	<div class="contact-box">
		<div class="container">
			...
			<input type="hidden" name="nam" id="nam" value="${namhientai }" />
			<input type="hidden" name="thang" id="thang" value="${thanghientai }" />
			<div class="submit-button text-center">
			<h3>Tính Lương cho tháng ${thanghientai } năm  ${namhientai }</h3>
			</div>
			<table class="table">
				
				<tr> 
					<td colspan="3"> Số ngày công của tháng</td>
					<td> <input type="text" class="form-control" id="ngaycongthang" name="ngaycongthang" > 
						<p class="error-ngaycongthang color-red"></p>
					</td>
				</tr>
				<tr> 
					<td>Tên</td>
				...
				<c:forEach var="nv" items="${dsNV }"> 
					...
					<tr> 
						...
						<td>${nv.email }</td>
						<td><input type="text" value="${nv.tongcongthang}" class="form-control" disabled name="songaycong<%=a %>" id="songaycong<%=a %>">
						<input type="hidden"  id="idnv<%=a %>" name="idnv<%=a %>" value="${nv.id }" >
						<p class="error-songaycong<%=a %> color-red"></p>
						 </td>
					</tr>
				</c:forEach>
				
			</table>
				<input type="hidden" id="slnv" name="slnv" value="<%=a %>" >
