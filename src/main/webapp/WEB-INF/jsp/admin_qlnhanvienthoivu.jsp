...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Quản lý nhân viên thời vụ</title>  
			...
			<div class="col-lg-6">
						...
						<div class="col-lg-6">
							<div class="heading-title text-center">
								<form action="timnhanvienthoivu" method="get">
				...
				<table class="table table-striped">
					...
					<tr>
						...
						<td>
							<a href="xemcongnvtv?id=${nv.id }" class="btn btn-success">Xem Công</a>
						</td>
						<td>
							<a href="capnhatnvtv?id=${nv.id }">
				...
				<div class="submit-button text-center">
				<a href="/themnvthoivu?trang=quanly" class="btn btn-common">Thêm Nhân Viên</a> 
				</div>
				</div>
			</div>
		</div>
