				...
				<div class="col-12">
					...
					<div class="row">
						...
						<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							...
							<table class="table">
								...
								<c:forEach var="lm" items="${loaimon }">
									<tr>
										<td>${lm.ten }</td>
										<td>${lm.loai }</td>
										<td><a href="/xoaloai?id=${lm.id }"><i class="fa fa-trash"></i> Xóa</a></td>
									</tr>
								</c:forEach>
							</table>
							...
							<a class="page-style1" href="qlloai?page=${pageTruoc}">Trước </a>
							<c:if test="${page1!=null}">
							<a class="page-style1" href="qlloai?page=${page1}">${page1 }</a></c:if>
							<c:if test="${page2!=null}">
							<a class="page-style1" href="qlloai?page=${page2}">${page2 }</a></c:if>
							<a class="page-style" href="">${pageHienTai }</a>
							<c:if test="${page4!=null}">
							<a class="page-style1" href="qlloai?page=${page4}">${page4 }</a></c:if>
							<c:if test="${page5!=null}">
							<a class="page-style1" href="qlloai?page=${page5}">${page5 }</a></c:if>
							<a class="page-style1" href="qlloai?page=${pageSau}">Sau </a>
										<br>	<br>	<a class="btn btn-common" href="/themloai">Thêm Loại Mới</a>
						</div>
						</div>
					</div>
				</div>
