...
<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="dropdown-a">
									<a class="dropdown-item" href="/nhanvienthoivu"><i class="fa fa-odnoklassniki" aria-hidden="true"></i> Nhân viên thời vụ</a>
									<a class="dropdown-item" href="/dsnhomphucvu"><i class="fa fa-th-list" aria-hidden="true"></i> Nhóm phục vụ</a>
								</div>
	...
	<div class="contact-box">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<form action="formcapnhatnhanvien" method="get">
						<table class="table table-striped">
							<tr>
								<td><p>Tên</p></td>
								<td><p>${userDangNhap.ten}</p></td>
							</tr>
							<tr>
								<td><p>Giới tính</p></td>
								<td><p>${userDangNhap.gioitinh}</p></td>
							</tr>
							<tr>
								<td><p>Ngày sinh</p></td>
								<td><p>${userDangNhap.ngaysinh}</p></td>
							</tr>
							<tr>
								<td><p>Nơi sinh</p></td>
								<td><p>${userDangNhap.noisinh}</p></td>
							</tr>
							<tr>
								<td><p>Số điện thoại</p></td>
								<td><p>${userDangNhap.sodienthoai}</p></td>
							</tr>
							<tr>
								<td><p>Email</p></td>
								<td><p>${userDangNhap.email}</p></td>
							</tr>
							<tr>
								<td><p>Số CMND</p></td>
								<td><p>${userDangNhap.socmnd}</p></td>
							</tr>
							<tr>
								<td><p>Ngày vào</p></td>
								<td><p>${userDangNhap.ngaytao}</p></td>
							</tr>
							<tr>
								<td><p>Chức vụ</p></td>
								<td><p>${userDangNhap.chucvu}</p></td>
							</tr>
							<tr>
								<td><p>Lương</p></td>
								<td><p>${userDangNhap.luong}</p></td>
							</tr>
							<tr>
								<td><p>Thời gian cập nhật cuối cùng</p></td>
								<td><p>${userDangNhap.ngaycapnhat}</p></td>
							</tr>
						</table>
						<div class="submit-button text-center">
							<input type="submit" class="btn btn-common" value="Cập nhật">
							<%if(!StringUtil.ADMIN.equals(userDN.getChucvu())){
							%>
							<a  class="btn btn-common" href="xemluongcanhan">Xem Lương </a>
							<%} %>
