...
<li class="nav-item dropdown active">
	...
	<div class="contact-box">
		<div class="container">
			<div class="row">
			<div class="col-lg-12">
				<form action="luunhomthoivu" method="post" id="formnhomthoivu">
					<table class="table">
						<tr>
							<td>Tên</td>
							<td>
								<input class="form-control" type="text" name="ten" id="ten"  />
								<p class="error-ten color-red">${thongbaothemnhom }</p>
							</td>
						</tr>
						<tr>
							<td>Ca Làm</td>
						...
						<tr>
							<td>Lương (Lương mỗi nhân viên thuộc nhóm)</td>
							<td>
